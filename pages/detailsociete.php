...
$nomdesociete = $_GET["nomdesociete"];
$resultat = $bdd->query("SELECT * FROM societe INNER JOIN societaires ON idsociete = societe_idsociete INNER JOIN facture ON idsociete = idsociete WHERE nomdesociete = '" . $_GET['nomdesociete'] . "'");
