...
$resultat = $bd->query('SELECT societe.nom, societe.pays, societe.tva FROM societe INNER JOIN societe_has_type ON idsociete = societe_idsociete WHERE type_idtype = 1');
